...
# https://medium.com/geekculture/how-to-dockerize-a-python-script-b0af3cd11fb0 #ran into issues setting up docker
...
def getCoordinates(ip_address, api_key):
    ...
    return latitude, longitude  # Returns the lat and long as a tuple of Floats
...
print(output) # output is a tuple of Floats
